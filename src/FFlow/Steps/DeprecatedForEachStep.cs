...
[StepTags("built-in")]
[SilentStep]
[Obsolete("Use ForEachStep<T> instead. This step will be removed in a future version.")]
public class DeprecatedForEachStep : DeprecatedForEachStep<object>
{
    public DeprecatedForEachStep(Func<IFlowContext, IEnumerable> itemsSelector, IFlowStep itemAction)
...
[Obsolete("Use ForEachStep<T> instead. This step will be removed in a future version.")]
public class DeprecatedForEachStep<T> : IFlowStep, IDescribableStep
{
    private readonly Func<IFlowContext, IEnumerable<T>> _itemsSelector;
    private readonly IFlowStep _itemAction;
    
    public DeprecatedForEachStep(Func<IFlowContext, IEnumerable<T>> itemsSelector, IFlowStep itemAction)
    {
